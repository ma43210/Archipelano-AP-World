...
class ArchipelanoWorld(World):
    """
    Archipelano is the game that will make you never play Archipelago ever again (Yes, it's that bad).
    """
    ...
    web = web_world.ArchipelanoWebWorld()
    ...
    options_dataclass = options.ArchipelanoOptions
    options: options.ArchipelanoOptions
    # There is always one region that the generator starts from & assumes you can always go back to.
    # This defaults to "Menu", but you can change it by overriding origin_region_name.
    origin_region_name = "level_1"
    ...
    def create_item(self, name: str) -> items.ArchipelanoItem:
