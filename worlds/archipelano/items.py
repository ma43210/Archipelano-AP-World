...
DEFAULT_ITEM_CLASSIFICATIONS = {
    "Key_1": ItemClassification.progression,
    "Key_2": ItemClassification.progression,
    "Key_3": ItemClassification.progression,
    "Key_4": ItemClassification.progression,
    "Key_5": ItemClassification.progression,
    "Key_6": ItemClassification.progression,
    "Key_7": ItemClassification.progression,
    "Key_8": ItemClassification.progression,
    "Key_9": ItemClassification.progression,
    "Key_10": ItemClassification.progression,
    "Great Job!": ItemClassification.filler,
}
...
def get_random_filler_item_name(world: ArchipelanoWorld) -> str:
...
def create_item_with_correct_classification(world: ArchipelanoWorld, name: str) -> ArchipelanoItem:
    ...
    return ArchipelanoItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: ArchipelanoWorld) -> None:
    ...
    itempool: list[Item] = [
        world.create_item("Key_1"),
        world.create_item("Key_2"),
        world.create_item("Key_3"),
        world.create_item("Key_4"),
        world.create_item("Key_5"),
        world.create_item("Key_6"),
        world.create_item("Key_7"),
        world.create_item("Key_8"),
        world.create_item("Key_9"),
        world.create_item("Key_10"),
        world.create_item("Great Job!"),
    ]
